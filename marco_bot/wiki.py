...
# print(debut)
# print (fin)
# print(f"https://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/en.wikipedia/all-access/all-agents/Cat/monthly/{debut}/{fin}")
...
# cmd shift j   //kaggle ?? script api https://en.wikipedia.org/wiki/User:Novem_Linguae/Scripts/SpeciesHelper dtataset back4apps